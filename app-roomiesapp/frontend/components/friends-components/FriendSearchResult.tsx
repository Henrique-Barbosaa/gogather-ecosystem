...
export function FriendSearchResult({ externalId, displayName, username}: FriendProps) {
  ...
  return (
    <div className='flex flex-row h-12 border border-dashed border-ra-blue-dark rounded-md items-center px-2 gap-2'>
      <UserRound className='w-8 h-8 p-1 bg-ra-blue-light rounded-full'/>
