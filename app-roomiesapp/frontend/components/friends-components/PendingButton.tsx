            ...
            pending.map(obj => (
              <div key={obj.friendExternalId} className="border border-dashed rounded-sm p-2 flex flex-row justify-between items-center">
                <div className="flex flex-row items-center gap-2">
                  <UserRound className="w-8 h-8 p-1 bg-ra-blue rounded-full"/>
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <span
                    className="bg-ra-purple-light rounded-sm py-1 px-2 text-zinc-50 font-semibold
                      hover:bg-ra-purple-dark cursor-pointer transition-all"
