                        ...
                        <div className="flex items-center gap-2">
                          {isDebtor && dist.status === 'PENDING' && (
                            <button
                              ...
                              className="w-full px-3 py-2 text-xs font-semibold text-white bg-ra-green hover:bg-cyan-500 rounded-lg flex items-center justify-center gap-1.5 transition-colors"
                            >
          ...
          <div className="flex flex-col items-center gap-6 py-4">
            <div className="w-full bg-gray-50 p-4 rounded-lg flex items-center justify-between gap-3 border border-gray-200">
              ...
              <button 
                ...
                className="shrink-0 p-2 text-gray-500 hover:text-ra-green hover:bg-cyan-50 rounded-md transition-colors"
              >
            ...
            {selectedSplitId && (
              <button
                ...
                className="w-full py-2.5 text-sm font-semibold text-white bg-ra-green hover:bg-cyan-500 rounded-xl transition-colors disabled:opacity-70"
              >
