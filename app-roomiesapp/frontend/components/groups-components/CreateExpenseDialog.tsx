  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button className="px-4 py-2 text-sm font-semibold text-white bg-ra-green hover:bg-ra-green-dark rounded-xl transition-colors flex items-center gap-2">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded border-gray-300 text-ra-green focus:ring-ra-green"
            />
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="text-xs text-ra-green hover:underline font-medium"
              >
                + Adicionar pagador
              </button>
            </div>
          ...
          <div className="pt-4 border-t border-gray-100 flex justify-end">
            <button
              ...
              className="px-6 py-2 text-sm font-semibold text-white bg-ra-green hover:bg-cyan-500 rounded-xl transition-colors disabled:opacity-70"
            >
