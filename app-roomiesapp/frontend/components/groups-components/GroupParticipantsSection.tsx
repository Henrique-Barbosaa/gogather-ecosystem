        ...
        {members.map((member) => {
          ...
          return (
            <div key={member.externalId} className="flex items-center gap-3 group/member cursor-default">
              <div className="w-9 h-9 rounded-full bg-ra-green-extralight text-ra-green-dark flex items-center justify-center text-xs font-bold shrink-0 border border-ra-green/10 group-hover/member:bg-ra-green group-hover/member:text-white transition-colors duration-200">
                {initials}
              </div>
