        ...
        <CardContent className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-6 h-6 text-ra-green pointer-events-none" />
              <Input
                id="name" 
                name="name" 
                value={formData.name} 
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-ra-green pointer-events-none" />
              <Input
                id="date" 
                type="datetime-local" 
                name="date" 
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <AlignLeft className="absolute left-3 top-4 w-5 h-5 text-ra-green pointer-events-none" />
              <Textarea
                id="description" 
                name="description" 
