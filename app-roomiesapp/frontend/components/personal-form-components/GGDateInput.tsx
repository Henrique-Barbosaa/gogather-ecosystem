...
export function GGDateInput({ label, name, isRequired = false, className }: DateInputProps) {
  ...
  return (
    <div className={`flex flex-col my-2 ${className}`}>
      <p className="text-xs text-ra-blue-extradark">
          ...
          return (
            <div className="relative flex flex-row w-full">
              <PatternFormat
                ...
                value={currentValue}
                onBlur={field.onBlur}
                className="bg-ra-blue-extralight text-center h-8 w-full rounded-r-none border-ra-blue-extradark border-dotted"
              />
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="bg-ra-blue-extralight rounded-l-none h-8 border-l-0 border-ra-blue-extradark border-dotted">
                    <CalendarSearch className="text-ra-blue-extradark" />
                  </Button>
                </PopoverTrigger>
